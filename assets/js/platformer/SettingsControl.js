...
const SettingsControl = {
    ...
    gameSpeedInput() {
        ...
        gameSpeed.max = 8.0;
        gameSpeed.step = 0.1;
        gameSpeed.defaultValue = 2.0; // use defaultValue instead of custom property
        ...
        gameSpeed.addEventListener("change", () => { 
            ...
            let value = parseFloat(gameSpeed.value).toFixed(1);
            value = (value < gameSpeed.min || value > gameSpeed.max || isNaN(value)) ? gameSpeed.defaultValue : value;
            gameSpeed.value = value;
            GameEnv.gameSpeed = value; // update GameEnv with new game speed
