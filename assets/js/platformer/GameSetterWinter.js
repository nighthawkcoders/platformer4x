...
const assets = {  
  ...
  const objects = [
    ...
    { name: 'snowflake', id: 'coin', class: Coin, data: assets.obstacles.snowflake, xPercentage: 0.2100, yPercentage: 0.70 },
    { name: 'snowflake', id: 'coin', class: Coin, data: assets.obstacles.snowflake, xPercentage: 0.2619, yPercentage: 0.70 },
    { name: 'snowflake', id: 'coin', class: Coin, data: assets.obstacles.snowflake, xPercentage: 0.3136, yPercentage: 0.70 },
